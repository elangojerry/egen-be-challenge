...
@Rule(name="Weight Shoot", description="Action on 10% increase in weight")
public class WeightShootRule 
{
	@Autowired
	...
	@Action
	public void sendWeightShootAlert(Facts facts)
	{
		String message = "Weight increased more than 10%";
